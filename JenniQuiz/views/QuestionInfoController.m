...
- (void)viewDidLoad
{
    ...
    self.infoLabel.font = [UIFont fontWithName:[Config sharedInstance].boldFont size:14];
    ...
    self.questionsLabel.font = [UIFont fontWithName:[Config sharedInstance].boldFont size:18];
    ...
    self.startButton.titleLabel.font = [UIFont fontWithName:[Config sharedInstance].boldFont size:19.0f];
